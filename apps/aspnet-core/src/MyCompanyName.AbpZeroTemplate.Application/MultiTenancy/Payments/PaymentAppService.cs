...
namespace MyCompanyName.AbpZeroTemplate.MultiTenancy.Payments
{
    public class PaymentAppService : AbpZeroTemplateAppServiceBase, IPaymentAppService
    {
        ...
        public async Task<long> CreatePayment(CreatePaymentDto input)
        {
            ...
            {
                Description = GetPaymentDescription(input.EditionPaymentType, input.PaymentPeriodType,
                    targetEditionName, input.RecurringPaymentEnabled),
        ...
        private string GetPaymentDescription(EditionPaymentType editionPaymentType,
            PaymentPeriodType? paymentPeriodType, string targetEditionName, bool isRecurring)
        {
