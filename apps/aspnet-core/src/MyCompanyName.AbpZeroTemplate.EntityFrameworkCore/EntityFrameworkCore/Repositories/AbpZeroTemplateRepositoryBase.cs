...
namespace MyCompanyName.AbpZeroTemplate.EntityFrameworkCore.Repositories
{
    ...
    public abstract class
        AbpZeroTemplateRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<AbpZeroTemplateDbContext, TEntity,
            TPrimaryKey>
    ...
    /// <summary>
    ///     Base class for custom repositories of the application.
    ///     This is a shortcut of <see cref="AbpZeroTemplateRepositoryBase{TEntity,TPrimaryKey}" /> for <see cref="int" />
    ///     primary key.
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
