...
namespace MyCompanyName.AbpZeroTemplate.Tests.Auditing
{
    ...
    public class NamespaceStripper_Tests : AppTestBase
    {
        ...
        {
            var controllerName =
                _namespaceStripper.StripNameSpace("MyCompanyName.AbpZeroTemplate.Web.Controllers.HomeController");
            controllerName.ShouldBe("HomeController");
        }

        [Theory]
        [InlineData(
            "MyCompanyName.AbpZeroTemplate.Auditing.GenericEntityService`1[[MyCompanyName.AbpZeroTemplate.Storage.BinaryObject, MyCompanyName.AbpZeroTemplate.Core, Version=1.10.1.0, Culture=neutral, PublicKeyToken=null]]",
        ...
        [InlineData(
            "MyCompanyName.AbpZeroTemplate.Auditing.XEntityService`1[MyCompanyName.AbpZeroTemplate.Auditing.AService`5[[MyCompanyName.AbpZeroTemplate.Storage.BinaryObject, MyCompanyName.AbpZeroTemplate.Core, Version=1.10.1.0, Culture=neutral, PublicKeyToken=null],[MyCompanyName.AbpZeroTemplate.Storage.TestObject, MyCompanyName.AbpZeroTemplate.Core, Version=1.10.1.0, Culture=neutral, PublicKeyToken=null],]]",
