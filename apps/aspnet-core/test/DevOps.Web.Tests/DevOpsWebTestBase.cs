...
{
    public abstract class DevOpsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DevOpsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DevOpsWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<DevOpsDbContext> action)
        {
            using (var context = IocManager.Resolve<DevOpsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<DevOpsDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<DevOpsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DevOpsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DevOpsDbContext, Task<T>> func)
        {
            T result;
