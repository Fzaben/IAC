...
namespace MyCompanyName.AbpZeroTemplate.GraphQL.Tests.Users
{
    ...
    public class UserQuery_Tests : GraphQLTestBase<MainSchema>
    {
        ...
        public async Task Should_Get_Users()
        {
            ...
            const string expectedResult =
                "{\"users\": {\"totalCount\": 1,\"items\": [{\"name\": \"admin\",\"surname\": \"admin\",\"roles\": [{\"id\": 2,\"name\": \"Admin\",\"displayName\": \"Admin\"}],\"organizationUnits\": []}]}}";
